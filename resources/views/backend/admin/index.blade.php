<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="{{ url('backend/admin/search')}}" method="POST">
        ...
        <div class="bjui-searchBar">
            ...
            <button type="button" class="btn-blue btn" data-width='510' data-toggle="dialog" data-id="addrole"  data-fresh="true" data-url="{{route('backend.admin.create')}}" data-title="添加新用户">添加新用户</button>
